        ...
        mappedProducts = arr.map(elem => {
            ...
            <div class="card" style="text-align: center;background-color: #faf13e;margin-bottom:1rem;margin-top:0">
                <div class="card-body product">
                    ...
                    <svg id="delete-pencil" onclick="removeProduct('${elem._id}')" style="margin-left: 0.5rem;cursor:pointer;" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#f70a0a" class="bi bi-trash" viewBox="0 0 16 16">
